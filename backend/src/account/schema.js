import { Account, AccountTC } from "./model";
...
const AccountTypes = {
  accountObjectType: AccountTC.getType(),
  accountInputType: AccountTC.getInputType(),
};

export { AccountQuery, AccountMutation, AccountTypes };
